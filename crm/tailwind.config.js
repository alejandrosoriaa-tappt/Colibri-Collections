export default {
  ...
  theme: {
    extend: {
      colors: {
        // NKUVO CRM — café tierra + verde planta (estilo landing nkuvo.com)
        crm: {
          // Primary: verde planta (como los botones de la landing)
          primary:                '#2E6B30',
          'on-primary':           '#FFFFFF',
          'primary-container':    '#D7F0D0',
          'on-primary-container': '#0B2008',
          // Secondary: café tierra
          secondary:              '#7A5230',
          'on-secondary':         '#FFFFFF',
          'secondary-container':  '#FFDCBE',
          'on-secondary-container': '#2B1700',
          // Tertiary: terracota/arcilla
          tertiary:               '#96490F',
          'on-tertiary':          '#FFFFFF',
          'tertiary-container':   '#FFDBC8',
          'on-tertiary-container': '#331200',
          // Surfaces: crema cálido como la landing
          surface:                '#FBF9F4',
          'on-surface':           '#1C1B16',

# Cómo Ganar Más Dinero y Hacer de WhatsApp Tu Mejor Empleado

### La Guía Práctica — Configura WhatsApp Business Paso a Paso y Empieza a Ganar Más Clientes

**Por Alejandro Soria — Fundador, NKUVO Labs**

*Una Publicación de NKUVO Labs · Primera Edición*
...
1. Descarga la App (y Por Qué No Es Tu WhatsApp Personal)
2. Configura un Perfil que Genere Confianza
3. Activa Tus Respuestas Automáticas
4. Guarda Tus Respuestas con los Atajos
5. Crea Tu Catálogo
6. Consigue Tu Enlace y Código QR
7. Organiza a Cada Cliente con Listas
8. Cobra con Enlaces de Pago

**Parte 2 — Ponlo en Práctica**
9. Un Día con WhatsApp Business
10. Deja que la IA Escriba tus Mensajes
11. Da Seguimiento como un Profesional
...
> **¿Sabías qué?**
> WhatsApp es la app de mensajería más usada en México, con más del 90% de los usuarios de smartphone activos en ella todos los días. Para la mayoría de tus clientes, WhatsApp no es una opción entre varias — es la app que ya usan para todo lo que les importa: la familia, el negocio, los pagos. Encontrarlos ahí elimina la barrera más grande antes de que exista.
...
## Capítulo 1 — Descarga la App (y Por Qué No Es Tu WhatsApp Personal)

### Descarga, verifica y entiende la diferencia
...
> **📱 Hazlo en tu teléfono — Descarga WhatsApp Business (Gratis)**
> 1. Abre la **App Store** (iPhone) o **Google Play** (Android).
> 2. Busca **"WhatsApp Business"** y toca **Obtener / Instalar**. Busca el ícono con la letra **B** dentro del globo de chat — esa es la versión de negocio.
> 3. Ábrela y **verifica tu número de teléfono**. Si ya usas el WhatsApp normal con este número, la app te ofrecerá **transferir tus chats** — acepta.
> 4. Llena tu **nombre de negocio** y categoría. Listo.
>
> Nota: puedes conservar tu WhatsApp personal en un segundo número si quieres, pero la mayoría de los dueños de negocio simplemente convierten su número actual en su número de negocio.
...
## Capítulo 2 — Configura un Perfil que Genere Confianza

### Tu perfil es tu escaparate digital
...
> **📱 Hazlo en tu teléfono — Encuentra tus Herramientas de Negocio**
> Todo en este libro vive en un solo lugar. Aprende a llegar ahí una vez:
> - **Android:** abre **WhatsApp Business** → toca los **⋮** (tres puntos, arriba a la derecha) → **Herramientas para empresas**.
> - **iPhone:** abre **WhatsApp Business** → toca **Ajustes** (abajo a la derecha) → **Herramientas para empresas**.
>
> Para editar tu nombre, foto, descripción, dirección y sitio web, toca el nombre de tu negocio arriba de Ajustes → **Perfil de la empresa**.

<!--GFX:tools-->

Llena cada campo pensando en lo que un cliente quiere ver:

- **Nombre:** el nombre de tu negocio, claro y fácil de buscar (por ejemplo, *Consultorio Dental Sonríe*), no un apodo.
- **Foto:** un logo limpio, o una foto profesional si trabajas solo. La gente le compra a personas.
- **Descripción:** qué haces, a quién ayudas y por qué elegirte — en una o dos líneas.
- **Dirección, sitio web, correo, horarios:** complétalos todos. La información incompleta genera desconfianza.
...
> **📱 Hazlo en tu teléfono — Configura Tus Horarios**
> 1. Ve a tu **Perfil de la empresa** → toca **Horario de atención**.
> 2. Elige **Abierto con horario**.
> 3. Toca cada día para poner tu hora de apertura y cierre. Desactiva los días que no abres.
> 4. Toca **Guardar**.
...
## Capítulo 3 — Activa Tus Respuestas Automáticas

### Saluda a cada cliente, incluso mientras duermes
...
> **📱 Hazlo en tu teléfono — Activa tu Mensaje de Bienvenida**
> 1. Abre **Herramientas para empresas** → **Mensaje de bienvenida**.
> 2. Activa **Enviar mensaje de bienvenida**.
> 3. Toca el texto para editarlo. Pega tu mensaje.
> 4. Toca **Destinatarios** (por defecto: **Todos** los que te escriban por primera vez).
> 5. Toca **Guardar**.
...
> **📱 Hazlo en tu teléfono — Activa tu Mensaje de Ausencia**
> 1. Abre **Herramientas para empresas** → **Mensaje de ausencia**.
> 2. Activa **Enviar mensaje de ausencia**.
> 3. Pega tu mensaje.
> 4. Toca **Programar** → **Fuera del horario de atención** (usa el horario que configuraste en el Capítulo 2 — la opción más fácil).
> 5. Toca **Destinatarios**, luego **Guardar**.
...
## Capítulo 4 — Guarda Tus Respuestas con los Atajos

### Deja de escribir lo mismo todos los días
...
> **📱 Hazlo en tu teléfono — Crea un Atajo**
> 1. Abre **Herramientas para empresas** → **Respuestas rápidas**.
> 2. Toca **Agregar**.
> 3. En **Mensaje**, escribe la respuesta completa (por ejemplo, tus horarios o precios).
> 4. En **Atajo**, escribe una palabra clave como `horario` o `precios` (sin espacios).
> 5. Toca **Guardar**.
>
> Para usarlo: en cualquier chat, escribe **`/`** seguido del atajo (por ejemplo, `/horario`), y elígelo de la lista.

<!--GFX:quick-->

Empieza con cinco: `horario`, `precios`, `direccion`, `cita`, y `pago` (o lo que más te pregunten tus clientes). Si ahorras dos minutos por chat, con treinta chats al día recuperas una hora completa — todos los días.

---

## Capítulo 5 — Crea Tu Catálogo

### Un escaparate de un solo toque para tus servicios
...
> **📱 Hazlo en tu teléfono — Crea Tu Catálogo**
> 1. Abre **Herramientas para empresas** → **Catálogo**.
> 2. Toca **Agregar artículo**.
> 3. Agrega una o más **fotos** del servicio o producto.
> 4. Llena **Nombre**, **Precio** (o déjalo en blanco y agrega "Desde…" en la descripción), y **Descripción**.
> 5. Opcional: agrega un **enlace** (tu sitio web o página de citas).
> 6. Toca **Guardar**. Repite para cada servicio.
>
> Para enviarlo: dentro de cualquier chat, toca el **clip / +** → **Catálogo** → elige los artículos → **Enviar**.
...
## Capítulo 6 — Consigue Tu Enlace y Código QR

### Facilita al máximo iniciar una conversación
...
> **📱 Hazlo en tu teléfono — Consigue Tu Enlace y Código QR**
> 1. Abre **Herramientas para empresas** → **Enlace corto**.
> 2. Copia tu enlace listo para compartir (por ejemplo, `wa.me/521XXXXXXXXXX`) para tu sitio web, anuncios y redes sociales.
> 3. Toca **Editar mensaje predeterminado** para que el cliente vea, por ejemplo, *"¡Hola! Quisiera más información sobre…"*.
> 4. Toca **Código QR** → **Compartir** o **Guardar** para descargarlo e imprimirlo.

<!--GFX:shortlink-->

Pon el código QR en tarjetas de presentación, facturas, el escaparate de tu negocio, tu vehículo y tu firma de correo. Cada escaneo inicia una conversación.

---

## Capítulo 7 — Organiza a Cada Cliente con Listas

### Un CRM sencillo que ya tienes
...
> **📱 Hazlo en tu teléfono — Crea y Asigna Listas**
> - **Crear:** ⋮ / Ajustes → **Herramientas para empresas** → **Listas** → **Nueva lista** → nómbrala, elige un color → **Guardar**.
> - **Asignar:** mantén presionado un chat → toca el ícono de **lista** → elige la(s) lista(s).
> - **Ver una sola etapa:** toca el filtro de **Listas** arriba de tus chats y elige una lista para ver solo esos clientes.
...
## Capítulo 8 — Cobra con Enlaces de Pago

### Cobra sin la conversación incómoda
...
> **📱 Hazlo en tu teléfono — Ten Tu Enlace de Pago a la Mano**
> 1. Configura un enlace de pago con tu proveedor (Mercado Pago, Clip, un link de transferencia SPEI con tu CLABE, etc.).
> 2. Guárdalo como **Respuesta Rápida**: **Herramientas para empresas** → **Respuestas rápidas** → **Agregar** → pega tu enlace → atajo `pago` → **Guardar**.
> 3. En cualquier chat, escribe `/pago` y envía. El enlace se inserta directo — sin buscar nada.

<!--GFX:payment-->

Usa el mismo flujo sencillo con cada cliente para que tu flujo de efectivo sea predecible:
...
## Capítulo 9 — Un Día con WhatsApp Business
...
## Capítulo 10 — Deja que la IA Escriba tus Mensajes
...
- *Escribe un mensaje de bienvenida cálido de WhatsApp para [tu negocio] en [tu ciudad]. Que suene amigable y profesional.*
- *Reescribe esta respuesta para que suene más cálida y clara: [pega tu texto].*
- *Escribe un seguimiento amable, sin presión, para un cliente que recibió una cotización hace tres días.*
- *Escribe un recordatorio de pago cortés para una factura vencida.*
- *Dame cinco respuestas rápidas para [tu negocio].*
...
## Capítulo 11 — Da Seguimiento como un Profesional

### Mantente en contacto, sin ser insistente
...
- [ ] **Día 1** — Instala WhatsApp Business y completa tu perfil (Capítulos 1–2).
- [ ] **Día 2** — Activa tu mensaje de bienvenida y de ausencia (Capítulo 3).
- [ ] **Día 3** — Crea cinco Atajos (Capítulo 4).
- [ ] **Día 4** — Arma tu catálogo y consigue tu código QR (Capítulos 5–6).
- [ ] **Día 5** — Crea tus listas y agrega cada chat activo a una (Capítulo 7).
- [ ] **Día 6** — Configura tu enlace de pago (Capítulo 8).
- [ ] **Día 7** — Suma la IA a tu flujo y arranca tu hábito diario de seguimiento (Capítulos 10–11).
...
## Bonus 1 — Guiones Listos para Usar
...
## Bonus 2 — La Checklist Definitiva

Antes de gastar un solo peso en publicidad, asegúrate de haber completado esto.
...
- [ ] Horario, dirección, correo y sitio web
- [ ] Categoría seleccionada

**Herramientas**

- [ ] Mensaje de bienvenida activado
- [ ] Mensaje de ausencia activado (fuera de horario)
- [ ] Al menos cinco Atajos
- [ ] Catálogo con tus servicios principales
- [ ] Enlace corto y código QR guardados

**Organiza y cobra**

- [ ] Listas creadas
- [ ] Cada cliente activo en una lista
- [ ] Enlace de pago guardado como `/pago`
- [ ] Chats completados archivados

**Hábito diario**

- [ ] Abrir **Seguimiento pendiente** cada mañana
- [ ] Revisar **Pago pendiente** todos los días
- [ ] Pedir reseñas y referidos a clientes contentos
